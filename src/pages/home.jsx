...
function Home() {
  ...
  return (
    <>
      ...
      <section className='flex flex-col md:flex-row gap-20 md:gap-3 w-full items-center justify-around text-4xl mt-16 bg-gradient-to-l from-blue-100 to-blue-00 -50 p-8 text-center'>
